...
# S3-005: imports app.models.* (missing) and/or requires live external APIs.
pytestmark = pytest.mark.skip(reason="Phase 1 rewrite scope: app/models package not yet scaffolded; live external APIs required")
